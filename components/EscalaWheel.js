...
const makeStyles = (C) => StyleSheet.create({
  ...
  num: { fontFamily: FONT.display, fontSize: 27, color: C.grey || C.sub, minWidth: 42, textAlign: 'right', lineHeight: 30 },
  ...
  numOnTxt: { color: '#fff', fontFamily: FONT.display, fontSize: 22, includeFontPadding: false, textAlign: 'center' },
  ...
  dcTxt: { color: '#fff', fontFamily: FONT.display, fontSize: 19 },
