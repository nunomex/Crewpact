...
import { overlapsWindow, overlapDurationMin } from '../utils/time';
...
// Duração (min) da sobreposição de [startMin, endMin] com o WOCL.
export const woclOverlapMin = (startMin, endMin) =>
  overlapDurationMin(startMin, endMin, WOCL.start, WOCL.end);
