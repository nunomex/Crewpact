...
const { getAe, hasAe, getAeForProfile } = registry;
...
// Orientado pela BD: rule_type comanda + só pilotos.
eq('AE: rule_type AE + piloto', getAeForProfile({ company: { slug: 'easyjet', rule_type: 'AE' }, crewType: 'pilot' }) === ae, true);
eq('AE: rule_type FTL → null', getAeForProfile({ company: { slug: 'easyjet', rule_type: 'FTL' }, crewType: 'pilot' }), null);
eq('AE: cabine → null', getAeForProfile({ company: { slug: 'easyjet', rule_type: 'AE' }, crewType: 'cabin' }), null);
